...
<body>
    ...
    <main class="container-fluid">
            ...
            <div class="col-md-4">
                <form id="registroForm" action="registro.php" method="post">
                    <div class="form-group box">
                        ...
                        <label for="clave">Contraseña: <img id="ver" title="Ver Contraseña" src="imgs/eye-fill.svg"
                    ...
                    <button id="enviar" type="submit" class="button" value="Enviar">Enviar</button>
                </form>
                <div class="col-md-4"></div>
            </div>
        </div>

        <div id="errorClave" hidden class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <p class="text-danger">La contraseña debe tener una mayúscula, un carácter especial y una longitud
                    mínima de 8 caracteres.</p>
            </div>
            <div class="col-md-4"></div>
        </div>

        <div id='registroExitoso' hidden class='margins-tb row'>
            <div class='col-md-4'></div>
            <div class='col-md-4'>
                <h1>¡Registro Completado!</h1>
                <a class='button' href='iniciarsesion.php'>Iniciar Sesión</a>
            </div>
            <div class="col-md-4"></div>
        </div>

        <div id="errorRegistro" hidden class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <p class="text-danger">Ha ocurrido un error durante el registro. Por favor, inténtelo de nuevo.</p>
            </div>
            <div class="col-md-4"></div>
        </div>

        <div id="errorNombre" hidden class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <p class="text-danger">El nombre de usuario tiene que tener mínimo 6 caracteres de longitud.</p>
            </div>
            <div class="col-md-4"></div>
        </div>

        <div id="errorFormulario" hidden class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
        ...
        <div id="usuarioExistente" hidden class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
    ...
    <script type="text/javascript">
        ...
        document.getElementById("registroForm").addEventListener("submit", function (e) {
            ...
            if (nombre.trim() === '' || clave.trim() === '') {
                document.getElementById('errorFormulario').removeAttribute('hidden');
                document.getElementById('errorClave').setAttribute('hidden', true);
                document.getElementById('errorNombre').setAttribute('hidden', true);
                document.getElementById('usuarioExistente').setAttribute('hidden', true);
                return;
            }
            ...
            if (nombre.length < 6) {
                ...
                document.getElementById('errorFormulario').setAttribute('hidden', true);
                document.getElementById('errorClave').setAttribute('hidden', true);
                document.getElementById('usuarioExistente').setAttribute('hidden', true);
                return;
            }
            ...
            var regexClave = /^(?=.*[A-Z])(?=.*[\W_])(?=.{8,})/;
            if (!regexClave.test(clave)) {
                document.getElementById('errorClave').removeAttribute('hidden');
                document.getElementById('errorNombre').setAttribute('hidden', true);
                document.getElementById('errorFormulario').setAttribute('hidden', true);
                document.getElementById('usuarioExistente').setAttribute('hidden', true);
                return;
            ...
            // Crear un objeto FormData para enviar los datos del formulario mediante fetch
            ...
            fetch("registro.php", {
                ...
                .then(data => {
                    ...
                    if (data === "RegistroExitoso") {
                        ...
                        document.getElementById('usuarioExistente').removeAttribute('hidden');
                        document.getElementById('errorFormulario').setAttribute('hidden', true);
                        document.getElementById('errorClave').setAttribute('hidden', true);
                        document.getElementById('errorNombre').setAttribute('hidden', true);
                    } else {
        ...
        document.getElementById("ver").addEventListener("click", function () {
            ...
            var isPasswordVisible = claveInput.type === "text";
