...
include 'stock.php';
$id = 5; // ID del producto que quieres consultar
$stock = getStock($id);
?>
        ...
        <div class="container">
            <div class="row top">
                <div class="col-md-6 justify-content-center">
                    <div id="carouselStoneRing" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100 img-fluid" src="imgs/Stone ring/Stone ring_1.png"
                                    alt="First slide str">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="imgs/Stone ring/Stone ring_2.png"
                                    alt="Second slide str">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="imgs/Stone ring/Stone ring_3.png"
                                    alt="Third slide str">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="imgs/Stone ring/Stone ring_4.png"
                                    alt="Fourth slide str">
                            </div>
                        </div>
                        <a class="carousel-control-prev" href="#carouselStoneRing" role="button" data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="sr-only">Atrás</span>
                        </a>
                        <a class="carousel-control-next" href="#carouselStoneRing" role="button" data-slide="next">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="sr-only">Siguiente</span>
                        </a>
                    </div>
                    <h5 class="margin-descripcion">Stone Ring</h5>
                    <?php
                    if (isset($_SESSION['nombre_usuario'])) {
                        $precioConDescuento = 190 * (1 - $descuento);
                        echo '<p><b>' . number_format($precioConDescuento, 2) . '€</b> <span style="color: red; font-size: 12px;">-10%</span></p>';
                    } else {
                        echo '<p><b>' . number_format(190) . '€</b></p>';
                    }
                    ?>
                </div>
                ...
                <div class="col-md-6 justify-content-center descripcion">
                    <div class="row">
                        <div class="col-md-12 justify-content-center">
                            ...
                            <h1>Anillo Stone Ring</h1>
                            <?php
                            if (isset($_SESSION['nombre_usuario'])) {
                                $precioConDescuento = 190 * (1 - $descuento);
                                echo '<h3><b>' . number_format($precioConDescuento, 2) . '€</b> <span style="color: red; font-size: 12px;">-10%</span></h3>';
                            } else {
                                echo '<h3><b>' . number_format(190) . '€</b></h3>';
                            }
                            ?>
                            <h6>EDICIÓN LIMITADA</h6>
                            <p>Anillo artesanal de plata de ley 925, con piedra natural Ágata Turritella.</p>
        ...
        $(document).ready(function () {
            $('#carrito').click(function () {
                $.ajax({
                    ...
                    type: 'GET',
                    data: { id: 5 }, // ID del producto que deseas obtener
                    dataType: 'json',
