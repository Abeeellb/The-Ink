...
include 'stock.php';
$id = 4; // ID del producto que quieres consultar
$stock = getStock($id);
?>
        ...
        <div class="container">
            <div class="row top">
                <div class="col-md-6 justify-content-center">
                    <div id="carouselBracelet" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100 img-fluid" src="imgs/brazalets/Sin título-4.png"
                                    alt="First slide b">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="imgs/brazalets/Sin título-5.png"
                                    alt="Second slide b">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="imgs/brazalets/Sin título-2.png"
                                    alt="Third slide b">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="imgs/brazalets/Sin título-3.png"
                                    alt="Fourth slide b">
                            </div>

                        </div>
                        <a class="carousel-control-prev" href="#carouselBracelet" role="button" data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="sr-only">Atrás</span>
                        </a>
                        <a class="carousel-control-next" href="#carouselBracelet" role="button" data-slide="next">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="sr-only">Siguiente</span>
                        </a>
                    </div>
                    <h5 class="margin-descripcion">Bracelet</h5>
                    <?php
                    if (isset($_SESSION['nombre_usuario'])) {
                        $precioConDescuento = 260 * (1 - $descuento);
                        echo '<p><b>' . number_format($precioConDescuento, 2) . '€</b> <span style="color: red; font-size: 12px;">-10%</span></p>';
                    } else {
                        echo '<p><b>' . number_format(260) . '€</b></p>';
                    }
                    ?>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 justify-content-center">
                            ...
                            if (isset($_SESSION['nombre_usuario'])) {
                                ...
                                echo '<h3><b>' . number_format(260) . '€</b></h3>';
                            }
                            ?>
                            <h6>EDICIÓN LIMITADA</h6>
                            <p>Brazalete artesanal de plata de ley 925.</p>
        ...
        $(document).ready(function () {
            $('#carrito').click(function () {
                $.ajax({
                    ...
                    type: 'GET',
                    data: { id: 4 }, // ID del producto que deseas obtener
                    dataType: 'json',
