...
<body>
    ...
    <main class="container-fluid">
        <h1 class="mt-5 mb-4">Política de Envío y Entrega</h1>
        <p>Una vez realizado el pedido, se enviará un correo electrónico con la confirmación la compra. Cada pieza se
            fabrica individualmente de manera artesanal en nuestro propio taller por lo que el tiempo de preparación es
            de 10- 20 días laborables, el tiempo de envío dependerá del país.</p>
        <p>Una vez enviado el pedido, recibirás un email con tu número de seguimiento para que puedas rastrear tu
            paquete. Todos los pedidos efectuados a partir de las 10.00 h. se gestionarán a partir del día siguiente
            hábil. No se entregarán pedidos en fines de semana ni días festivos. Los tiempos de entrega pueden verse
            afectados por retrasos a causa del transporte, aduanas u otros factores externos.</p>

        <h2>COSTE DE ENVÍO</h2>
        <p>El coste de cada envío se calculará automáticamente y se detallará en el momento de confirmar la compra para
            que siempre sea aprobado por el cliente antes de confirmar el pago.</p>
    </main>
