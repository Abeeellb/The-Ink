    ...
    <header>
        ...
        <div class="buscar" id="buscar">
            <table class="buscar-table" id="buscarTable">
                ...
                <tbody>
                    <tr>
                        <td><a href="bonering.php"><img class="img-buscar" src="imgs/bone ring/Sin título-4.png" alt="bonering">Anillo
                                Bone Ring | <?php
                                if (isset($_SESSION['nombre_usuario'])) {
                    ...
                    <tr>
                        <td><a href="bracelete.php"><img class="img-buscar"
                                    src="imgs/brazalets/Sin título-4.png" alt="bracelete">Brazalete
                                Bracelete | <?php
                                if (isset($_SESSION['nombre_usuario'])) {
                    ...
                    <tr>
                        <td><a href="earrings.php"><img class="img-buscar"
                                    src="imgs/Earings/Sin título-2.png" alt="earrings">Pendientes
                                Earrings | <?php
                                if (isset($_SESSION['nombre_usuario'])) {
                                    $precioConDescuento = 130 * (1 - $descuento);
                                    echo '<b>' . number_format($precioConDescuento, 2) . '€</b> <span style="color: red; font-size: 12px;">-10%</span>';
                    ...
                    <tr>
                        <td><a href="sealring.php"><img class="img-buscar" src="imgs/seal ring/Sin título-2.png" alt="sealring">Anillo
                                Seal Ring | <?php
                                if (isset($_SESSION['nombre_usuario'])) {
                    ...
                    <tr>
                        <td><a href="stonering.php"><img class="img-buscar"
                                    src="imgs/Stone ring/Stone ring_1.png" alt="stonering">Anillo
                                Stone Ring | <?php
                                if (isset($_SESSION['nombre_usuario'])) {
            ...
            <div class="row">
                ...
                <div class="col-md-4 top justify-content-center">
                    <a href="pendientes.php" class="img-container-3">
                        <img class="img-fluid" src="imgs/Earings/Sin título-3.png" alt="Imagen 2">
                    </a>
                ...
                <div class="col-md-4 top justify-content-center">
                    <a href="brazaletes.php" class="img-container-3">
                        <img class="img-fluid" src="imgs/brazalets/Sin título-2.png" alt="Imagen 3">
                    </a>
        ...
        <div class="container">
            <div class="row footer-container">
                ...
                <div class="col-md-3">
                    <h3>Síguenos en:</h3>
                    <div class="redes">
                        <a href="https://www.instagram.com/theink.jewellery/"><img class="red" src="imgs/insta.png" alt="insta"></a>
                        <a href="https://www.tiktok.com/@theink.jewellery"><img class="red" src="imgs/tiktok.png" alt="tiktok"></a>
                    </div>
                </div>
            </div>
        </div>
