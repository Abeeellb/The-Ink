...
include 'stock.php';
$id = 1; // ID del producto que quieres consultar
$stock = getStock($id);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            <div class="row top">
                <div class="col-md-6 justify-content-center">
                    <div id="carouselBoneRing" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100 img-fluid" src="imgs/bone ring/Sin título-4.png"
                                    alt="First slide br">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="imgs/bone ring/Sin título-5.png"
                                    alt="Second slide br">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="imgs/bone ring/Sin título-6.png"
                                    alt="Third slide br">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="imgs/bone ring/Sin título-3.png"
                                    alt="Fourth slide br">
                            </div>
                        </div>
                        <a class="carousel-control-prev" href="#carouselBoneRing" role="button" data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="sr-only">Atrás</span>
                        </a>
                        <a class="carousel-control-next" href="#carouselBoneRing" role="button" data-slide="next">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="sr-only">Siguiente</span>
                        </a>
                    </div>
                    <h5 class="margin-descripcion">Bone Ring</h5>
                    <?php
                    if (isset($_SESSION['nombre_usuario'])) {
                        $precioConDescuento = 130 * (1 - $descuento);
        ...
        $(document).ready(function () {
            $('#carrito').click(function () {
                $.ajax({
                    ...
                    type: 'GET',
                    data: { id: 1 }, // ID del producto que deseas obtener
                    dataType: 'json',
