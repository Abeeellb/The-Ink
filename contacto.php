...
<head>
    ...
    <title>Información de Contacto</title>
...
<body>
    ...
    <main class="container-fluid">
        <h1 class="mt-5 mb-4">Información de Contacto</h1>
        <h2>ATENCIÓN AL CLIENTE</h2>
        <p>Si tienes alguna pregunta con respecto a su pedido, deseas que te ayudemos con la talla de tu anillo o
            simplemente quieres decir ¡Hola! Escríbenos un email a theink.jewellery@gmail.com </p>

        <h2>VENTA AL MAYOR Y COLABORACIONES</h2>
        <p>Para discutir una posible colaboración, consulta mayorista o solicitud de prestación, puede contactarnos en
            theink.jewellery@gmail.com</p>

        <h2>PRENSA</h2>
        <p>Para préstamos de piezas envía un email a theink.jewellery@gmail.com</p>
        <p>Para consultas de prensa, envíenos un correo electrónico a theink.jewellery@gmail.com</p>

        <h2>TRABAJA CON NOSOTROS</h2>
        <p>theink.jewellery@gmail.com</p>
        <p>ESCRÍBENOS</p>
        <p>+34 638 462 250</p>
