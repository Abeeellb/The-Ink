...
include 'stock.php';
$id = 2; // ID del producto que quieres consultar
$stock = getStock($id);
?>
    ...
    <div class="container">
        <div class="row top">
            <div class="col-md-6 justify-content-center">
                <div id="carouselEarRings" class="carousel slide">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100 img-fluid" src="imgs/Earings/Sin título-2.png"
                                alt="First slide er">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100 img-fluid" src="imgs/Earings/Sin título-1.png"
                                alt="Second slide er">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100 img-fluid" src="imgs/Earings/Sin título-3.png"
                                alt="Third slide er">
                        </div>
                    </div>
                    <a class="carousel-control-prev" href="#carouselEarRings" role="button" data-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="sr-only">Atrás</span>
                    </a>
                    <a class="carousel-control-next" href="#carouselEarRings" role="button" data-slide="next">
                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                        <span class="sr-only">Siguiente</span>
                    </a>
                </div>
                <h5 class="margin-descripcion">Ear Rings</h5>
                <?php
                if (isset($_SESSION['nombre_usuario'])) {
                    $precioConDescuento = 130 * (1 - $descuento);
                    echo '<p><b>' . number_format($precioConDescuento, 2) . '€</b> <span style="color: red; font-size: 12px;">-10%</span></p>';
                } else {
                    echo '<p><b>' . number_format(130) . '€</b></p>';
                }
                ?>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 justify-content-center">
                        ...
                        if (isset($_SESSION['nombre_usuario'])) {
                            ...
                            echo '<h3><b>' . number_format(130) . '€</b></h3>';
                        }
                        ?>
                        <h6>EDICIÓN LIMITADA</h6>
                        <p>Pendientes artesanales de plata de ley 925.</p>
                        <p>Hecho a mano en Madrid, España.</p>
                ...
                <div class="row">
                    <div class="col-md-12 justify-content-center">
                        <form id="comprar">
                            ...
                            <input class="box-size" type="number" id="cantidad" name="cantidad" min="1" max="3"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (!productoExistente) {
                            ...
                            $.ajax({
                                url: 'carritoconexion.php',
                                type: 'POST',
                                data: { id: id, nombre: nombre, precio: precio, img: img, cantidad: cantidad },
                                success: function (response) {
                            ...
                            alert('Producto ya añadido al carrito');
                            location.reload(); // Recargar la página para reflejar los cambios en el carrito
                        }
                    },
                    error: function (xhr, status, error) {
            ...
            $("#comprar").on("submit", function (e) {
                ...
                var id = $("#id").val();
                var cantidad = $('#cantidad').val(); // Asegurarse de enviar la cantidad

                $.ajax({
                    type: "POST",
                    url: "nuevostock.php",
                    data: { id: id, cantidad: cantidad }, // Enviar también la cantidad
                    success: function (response) {
