...
<body>
    ...
    <main class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-4">
                <form id="formNombre" action="recuperarclave.php" method="post" class="needs-validation" novalidate>
                    <div class="form-group box">
                        ...
                        <button class="button" id="siguiente" type="submit" value="Siguiente">Siguiente</button>
                    </div>
                </form>
            </div>
        </div>

        <div id="falloNombre" hidden class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <p class="text-danger">El nombre de usuario es incorrecto.</p>
            </div>
        </div>

        <form id="formNuevaClave" hidden class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <h1>Nueva Contraseña</h1>
                <label for="clave">Introduzca su nueva contraseña: </label>
        ...
        <div id="claveNoValida" hidden class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
        ...
        <div id="nuevaClaveExito" hidden class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
        ...
        <div id="falloNuevaClave" hidden class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
    ...
    <script type="text/javascript">
        $("#siguiente").on("click", function (e) {
            ...
            if (nombre.trim() === '') {
                $('#errorFormulario').removeAttr('hidden');
                $('#falloNombre').attr('hidden', true);
                $('#formNuevaClave').attr('hidden', true);
                return;
            }
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response === "existe") {
                        // El nombre de usuario existe, mostrar el formulario de nueva clave
                        $('#formNuevaClave').removeAttr('hidden');
                        $('#errorFormulario').attr('hidden', true);
                        $('#falloNombre').attr('hidden', true);
                        $('#formNombre').attr('hidden', true);
                    } else {
                        // El nombre de usuario no existe, mostrar mensaje de error
                        $('#falloNombre').removeAttr('hidden');
                        $('#errorFormulario').attr('hidden', true);
                        $('#formNuevaClave').attr('hidden', true);
                    }
                }
        ...
        $(document).ready(function () {
            $("#enviar").on("click", function (e) {
                ...
                if (clave.trim() === '') {
                    $('#errorFormulario').removeAttr('hidden');
                    $('#claveNoValida').attr('hidden', true);
                    return;
                }
                ...
                if (!regexClave.test(clave)) {
                    $('#claveNoValida').removeAttr('hidden');
                    $('#errorFormulario').attr('hidden', true);
                    return;
                }
                ...
                $.ajax({
                    type: "POST",
                    url: "comprobarnuevaclave.php",
                    data: { clave: clave, nombre: nombre },
                    success: function (response) {
                        if (response === "claveExito") {
                            // El nombre de usuario existe, mostrar el formulario de nueva clave
                            $('#nuevaClaveExito').removeAttr('hidden');
                            $('#formNuevaClave').attr('hidden', true);
                            $('#errorFormulario').attr('hidden', true);
                            $('#claveNoValida').attr('hidden', true);
                        } else {
                            // El nombre de usuario no existe, mostrar mensaje de error
                            $('#falloNuevaClave').removeAttr('hidden');
                            $('#errorFormulario').attr('hidden', true);
                            $('#formNuevaClave').attr('hidden', true);
                            $('#claveNoValida').attr('hidden', true);
                        }
